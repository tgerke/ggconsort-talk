...
Thanks to the amazing organizers of R/Medicine! I'm so happy to be back this year, all of the sessions so far have been incredible. I'm Travis Gerke, Director of Data Science at the Prostate Cancer Clinical Trials Consortium, where we manage about a quarter of all active early phase prostate cancer therapeutic trials in the US, with an increasing portfolio of international and late-phase studies as well. Our data science team is hiring, so feel free to reach out if you're looking. I'm here today to talk about CONSORT diagrams.
